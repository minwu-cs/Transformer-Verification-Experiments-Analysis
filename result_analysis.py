...
def plot_figure(method1, method1_name, method2, method2_name):
    values1 = method1.get(1) + method1.get(2) + method1.get(3)
    values2 = method2.get(1) + method2.get(2) + method2.get(3)
    ...
    plt.savefig(directory + method1_name + '_vs_' + method2_name + '.png')
